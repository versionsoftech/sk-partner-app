class ConfigModel {
  ...
  bool? takeawayOrderVerification;
  bool? cashOnDelivery;
  bool? digitalPayment;
  ...
  ConfigModel({
    ...
    this.takeawayOrderVerification,
    this.cashOnDelivery,
    this.digitalPayment,
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    takeawayOrderVerification = json['takeaway_order_verification'] ?? json['order_delivery_verification'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['takeaway_order_verification'] = takeawayOrderVerification;
