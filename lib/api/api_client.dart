...
class ApiClient extends GetxService {
  ...
  Response handleResponse(http.Response response, String uri, bool handleError) {
    ...
    if(response0.statusCode != 200 && response0.body != null && response0.body is !String) {
      ...
      } else if (response0.body is Map && response0.body['errors'] != null) {
        try {
          ErrorResponse errorResponse = ErrorResponse.fromJson(response0.body);
          response0 = Response(statusCode: response0.statusCode, body: response0.body, statusText: errorResponse.errors![0].message);
        } catch (_) {}
      } else if (response0.body is Map && response0.body['message'] != null) {
        response0 = Response(statusCode: response0.statusCode, body: response0.body, statusText: response0.body['message'].toString());
      }
